...
(function() {
  ...
  var FramerOptions = (function() {
    ...
    FramerOptions.prototype.afrumLabel = function(curImageNum, afrumSize) {
      return "Attachment " + curImageNum + " of " + afrumSize;
    };
  ...
  var Framer = (function() {
    ...
    Framer.prototype.build = function() {
      var self = this;
      $("<div id='framerOverlay' class='framerOverlay'></div><div id='framer' class='framer'><div class='fr-outerContainer'><div class='fr-container'><iframe class='fr-image' src='' ></iframe><img class='fr-image' src='' /><p class='fr-download-link'>Preview cannot supported, click <a href=''>here</a> to download</p><div class='fr-loader'><a class='fr-cancel'></a></div></div><a class='fr-prev' href='' ></a><a class='fr-next' href='' ></a></div><div class='fr-dataContainer'><div class='fr-data'><div class='fr-details'><span class='fr-caption'></span><span class='fr-number'></span></div><div class='fr-closeContainer'><a class='fr-close'></a></div></div></div></div>").appendTo($('body'));
    ...
    Framer.prototype.start = function($link) {
      ...
      function addToAfrum($link) {
        self.afrum.push({
          ...
          download: $link.attr('data-download')
        });
      }
    ...
    Framer.prototype.changeImage = function(imageNumber) {
      ...
      var $iframe = this.$framer.find('iframe.fr-image');
      var $image = this.$framer.find('img.fr-image');
      var isPdf = /\.pdf/.test(this.afrum[imageNumber].download);
      var isImage = /\.(jpg|jpeg|png)/.test(this.afrum[imageNumber].download);
      var isOther = !isPdf && !isImage;
      if(isPdf) {
      ...
      $image.css({
        width: isImage || isOther ? "auto" : $(window).width()*0.7-self.containerRightPadding*2,
        height: isPdf ? $(window).height()*0.7 : "auto",
        maxWidth: $(window).width()*0.7-self.containerRightPadding*2,
      });
      ...
      self.sizeContainer($image.attr('width')*1, $(window).height()*0.7);
      if (isOther) {
        $(".fr-download-link").removeClass("d-none").find("a").attr("src", this.afrum[imageNumber].download)
      } else {
        $(".fr-download-link").addClass("d-none")
      }
